        ...
        <div id="content">
            ...
            <section id="rooms_section">
                ...
                <div class="filter_rooms_wrapper d-flex justify-content-center text-center py-60 relative">
                    ...
                    <ul class="filter_rooms js_drop_down clearfix relative">
                        <li class="float-left">All</li>
                        <li class="float-left">Apartments</li>
                        <li class="float-left">Double Room</li>
                        <li class="float-left">Single Room</li>
                        <li class="float-left">Family Room</li>
                    </ul>
                </div>
                ...
                <div id="rooms_list" class="offer_container row">
                    ...
                    <div class="offer_content col-12 col-sm-6 col-xl-4 relative my-15">
...
//                 console.log('scrolled');
                ...
                paginateData("http://localhost/tamara/luxury_hotel/structure/rooms.php", {page: page, offset: 3}, 'rooms', '#rooms_list');
//                paginateData("http://localhost/tamara/luxury_hotel/structure/rooms.php", {page: page, offset: 3}, 'restaurant', '#restaurant_offer');
            }
        });
    });
