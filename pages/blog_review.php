        ...
        <div id="content">
            ...
            <section id="blog_review_section">
                ...
                <div id="blog_review" class="row">
                    ...
                    <div class="blog_review container col-7">
                        ...
                        <div class="blog_container">
                            <div class="blog_content py-60 clearfix">
                                ...
                                <ul class="comments float-left py-4 text-center w-100">

                                    <li class="float-left px-3 col-4">
