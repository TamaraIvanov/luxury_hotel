        ...
        <div id="content">
            ...
            <section id="restaurant_section">
                ...
                <div class="filter_wrapper d-flex justify-content-center text-center py-60 relative">
                    ...
                    <ul class="js-drop-list filter_offers clearfix">
                        <li class="float-left" data-id="all">All</li>
                        <li class="float-left" data-id="breakfast">Breakfast</li>
                        <li class="float-left" data-id="lunch">Lunch</li>
                        <li class="float-left" data-id="dinner">Dinner</li>
                        <li class="float-left" data-id="drinks">Drinks</li>
                    </ul>
                </div>

                <div id="restaurant_offer" class="offer_container row">

                    <div class="offer offer_content col-12 col-sm-6 col-xl-4 float-left relative my-15" data-type="lunch">
                    ...
                    <div class="offer offer_content col-12 col-sm-6 col-xl-4 col-xl-4 float-left relative my-15" data-type="dinner">
                    ...
                    <div class="offer offer_content col-12 col-sm-6 col-xl-4 float-left relative my-15" data-type="breakfast">
